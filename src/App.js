...
function App() {
  ...
  const priorityLabels = {
    0:(
      ...
      <img src="3 dot menu.svg" className='user-pic' alt="Backlog" /> Backlog
      </div>
    ),
    2:(
      <div className="user-label">
      <img src={process.env.PUBLIC_URL + "/l.jpg"} className='user-pic' alt="Todo" />  Todo
      </div>
    ),
    3:(
      <div className="user-label">
      <img src={process.env.PUBLIC_URL + "/m.jpg"} className='user-pic' alt="In progress" />  In progress
      </div>
    ), 
    4:(
      <div className="user-label">
      <img src={process.env.PUBLIC_URL + "/h.jpg"}  className='user-pic' alt="Done" />  Done
      </div>
    ),  
    1:(
      <div className="user-label">
      <img src="3_dot_menu.svg" className='user-pic' alt="Cancelled" />  Cancelled
      </div>
    )
  };
